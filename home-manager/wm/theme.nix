...
rec {
  ...
  xdg.configFile = {
    "gtk-3.0/assets".source = "${gtk.theme.package}/share/themes/${gtk.theme.name}/gtk-3.0/assets";
    "gtk-3.0/gtk.css".source = "${gtk.theme.package}/share/themes/${gtk.theme.name}/gtk-3.0/gtk.css";
