...

{
  programs.kitty = {
    ...
    extraConfig = ''
      ...
      font_family Iosevka Custom Nerd Font Mono
      font_size 14

      font_features IosevkaCustomNFM +calt +liga +dlig +ss01 +ss02 +ss03 +ss04 +ss05 +ss06 +ss07 +ss08
      font_features IosevkaCustomNFM-Bold +calt +liga +dlig +ss01 +ss02 +ss03 +ss04 +ss05 +ss06 +ss07 +ss08
      font_features IosevkaCustomNFM-BoldItalic +calt +liga +dlig +ss01 +ss02 +ss03 +ss04 +ss05 +ss06 +ss07 +ss08
      font_features IosevkaCustomNFM-Italic +calt +liga +dlig +ss01 +ss02 +ss03 +ss04 +ss05 +ss06 +ss07 +ss08
      '';
