  ...
  neovide =
    rustPlatform.buildRustPackage.override { stdenv = clangStdenv; } rec {
      ...
      SKIA_SOURCE_DIR = let
        ...
        # You need to create this JSON file in the same directory as your config
        # or fetch it from somewhere
        skiaExternalsJson = writeTextFile {
          name = "skia-externals.json";
          text = builtins.readFile ./skia-externals.json;
        };
        ...
        externals = linkFarm "skia-externals" (lib.mapAttrsToList
          ...
          }) (pkgs.lib.importJSON skiaExternalsJson));
      ...
      meta = {
        ...
        changelog =
          "https://github.com/neovide/neovide/releases/tag/${version}";
        license = with lib.licenses; [ mit ];
        maintainers = with lib.maintainers; [ ck3d ];
        platforms = lib.platforms.unix;
      };
    };
in { home.packages = [ neovide ]; }
