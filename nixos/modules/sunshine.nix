# copied from redxtech/nixfiles: https://github.com/redxtech/nixfiles/blob/dec2a5f5acbc4efa646722b0aeff8b3137596979/modules/nixos/sunshine.nix
...
in {
  options.services.sunshine = with types; {
    enable =
      mkEnableOption "Sunshine, a self-hosted game stream host for Moonlight";
  ...
  config = mkIf cfg.enable {
    services.sunshine.settings.file_apps =
      mkIf (cfg.applications.apps != [ ]) "${appsFile}";
